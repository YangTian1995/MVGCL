def add_args(parser):
    ...
    parser.add_argument("--data_dir", default="./dataset/BioRED_format_new", type=str)
    parser.add_argument("--transformer_type", default="bert", type=str)
    parser.add_argument("--model_name_or_path", default="BiomedNLP-BiomedBERT-base-uncased-abstract" , type=str)

    parser.add_argument("--train_file", default="Train.BioC.JSON", type=str)
    parser.add_argument("--dev_file", default="Test.BioC.JSON", type=str)
    parser.add_argument("--test_file", default="Test.BioC.JSON", type=str)
    parser.add_argument("--pred_file", default="results.json", type=str)
    parser.add_argument("--save_path", default="results/debug", type=str)
    ...
    parser.add_argument("--gcn_layers", default=1, type=int, help="GCN layers")
    parser.add_argument("--iters", default=2, type=int, help="Iteration")
    parser.add_argument("--use_graph",default = True, help="Use graph",type = bool)
    ...
    parser.add_argument("--evi_lambda", default=0, type=float,
    ...
    parser.add_argument("--lr_added", default=2e-4, type=float,
    ...
    parser.add_argument("--special_token", default = False, type=bool,
                        help="Number of relation types in dataset.")
